...
{
?>
<center><b>Consulta de Visitantes</b></center></br>
<?php
//$id_visitante_t2="";
//$id_asunto2="";
$ls_criterio="";
...
<?php
	$_pagi_sql = "select a.id_visitante_h, a.cedula, a.cod_procedencia, a.procedencia, a.cod_emisor, a.emisor, a.fecha_e, a.fecha_s, a.id_asunto, a.observacion, a.id_carnet, b.nombre, b.apellido, b.id_visitante_t, c.asunto, d.tipo, e.autorizacion_nombre from visitantes_h a, visitantes b, asuntos c, visitantes_t d, visitantes_a e where a.fecha_s='0000-00-00 00:00:00' and a.cedula=b.cedula and a.id_asunto=c.id_asunto and b.id_visitante_t=d.id_visitante_t and a.id_visitante_h=e.id_visitante_h and (a.cod_procedencia<>'' or a.procedencia<>'') and (a.cod_emisor<>'' or a.emisor<>'') $ls_criterio order by a.fecha_e DESC "; 
...
//			$telefono_movil=$campo ['telefono_movil'];
			...
			$html_c=$html_c."<td style='width: 14%'>$procedencia&nbsp;</td>";
			$html_c=$html_c."<td style='width: 14%'>$emisor&nbsp;</td>";
...
<form name="reporte" method="post" action="sca_visitante_r.php">
