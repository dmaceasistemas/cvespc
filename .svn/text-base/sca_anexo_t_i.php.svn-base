...
/*Modulo de Inclusion de los Tipos de Anexos*/
conectar();
?>
<?php 
...
<form id="form2" name="form2" method="post" action="sca_case.php">
  <table border="1" align="center" cellpadding="2" cellspacing="0">
    <tr>
      <td colspan="2" class="celdas"><div align="center"><b>Inclusión de Tipo Anexo</b></div></td>
    </tr>
    <tr>
      <td class="celdas"><div align="right">Tipo</div></td>
      <td><input name="anexo_t" type="text" size="50"/></td>
	<input name="seleccion" type="hidden" value="18"/> 
