 ...
 */
	...
	$cabecera=$cabecera."<td style='width: 80%;'>Ministerio del Poder Popular para la Cultura <br> SCA - Sistema de Control de Acceso y Correspondencia<br> $fecha_reporte  <br><b>Reporte de Visitantes Actuales</b></td>";
	$cabecera=$cabecera."</tr>";
	$cabecera=$cabecera."</table>";
	//Fin cabecera
	...
	$html=$html."<td class='celdas' style='width: 14%;'>Procedencia</td>";
	$html=$html."<td class='celdas' style='width: 14%;'>Destino</td>";
	$html=$html."<td class='celdas' style='width: 8%;'>Fecha de Entrada</td>";
