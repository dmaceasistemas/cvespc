 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	...
 	$_pagi_result2 = sql_c($_pagi_sqlConta);
...
if ($_pagi_navegacion=="<span ".$_pagi_nav_estilo_mod.">1</span>")
	$_pagi_navegacion="";
else
	$_pagi_navegacion="<p><center>$_pagi_navegacion</center></p>";
//------------------------------------------------------------------------
 ...
 */
 ...
 $_pagi_result = sql_c($_pagi_sqlLim);
 // Si ocurrió error y mostrar errores está activado
 ...
 */
 ...
 $_pagi_info = "$_pagi_desde - $_pagi_hasta de $_pagi_totalReg Registros";
